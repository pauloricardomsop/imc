...
class ConsulteSeusValoresCaptchaBottom extends StatefulWidget {
  ...
  @override
  State<ConsulteSeusValoresCaptchaBottom> createState() =>
      _ConsulteSeusValoresCaptchaBottomState();
}

class _ConsulteSeusValoresCaptchaBottomState
    extends State<ConsulteSeusValoresCaptchaBottom> {
  final ConsultaCPFController _controller = ConsultaCPFController();

  @override
  Widget build(BuildContext context) {
    return StreamOut<ConsultaCPFViewModel>(
      loading: _shimmer(),
