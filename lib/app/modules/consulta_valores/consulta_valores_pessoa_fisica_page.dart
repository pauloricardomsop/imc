...
class ConsultaValoresPessoaFisicaPage extends JourneyStatefulWidget {
  const ConsultaValoresPessoaFisicaPage({Key? key})
      : super(key: key, name: 'ConsultaValoresPessoaFisicaPage');

  @override
  State<ConsultaValoresPessoaFisicaPage> createState() => ConsultaValoresPessoaTipoPageState();
}

class ConsultaValoresPessoaTipoPageState extends State<ConsultaValoresPessoaFisicaPage> {
  @override
  void initState() {
              ...
              child: Column(
                ...
                children: [
                  ...
                  const HeaderHero(
                    ...
                    desc:
                        'Inicie sua consulta acessando o site valoresareceber.bcb.gov.br logo após, você verá um formulário de consulta pública. Para consultar valores esquecidos no banco, você deverá inserir o tipo de documento que será consultado, seguido do CPF e Data de Nascimento.\n\nApós realizar este processo, basta clicar em consultar.',
                  ),
                  const H(16),
                  const AppImage(
                      url:
