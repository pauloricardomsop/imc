...
class ValeGasHowRegisterNecessaryDocumentsPage extends JourneyStatefulWidget {
  const ValeGasHowRegisterNecessaryDocumentsPage({super.key})
      : super(name: 'ValeGasHowRegisterNecessaryDocumentsPage');

  @override
  State<ValeGasHowRegisterNecessaryDocumentsPage> createState() =>
      _BfHowRegisterNecessaryDocumentsPage();
}

class _BfHowRegisterNecessaryDocumentsPage extends State<ValeGasHowRegisterNecessaryDocumentsPage> {
          ...
          child: Column(
            ...
            children: [
              ...
              HeaderHero(
                ...
                desc:
                    'Listamos abaixo os documentos que você precisa apresentar na hora de se cadastrar no Vale Gás.',
              ),
              const H(32),
