...
class ValeGasHasRightsHomePage extends JourneyStatefulWidget {
  const ValeGasHasRightsHomePage({super.key}) : super(name: 'ValeGasHasRightsHomePage');

  @override
  State<ValeGasHasRightsHomePage> createState() => _ValeGasHasRightsHomePage();
}

class _ValeGasHasRightsHomePage extends State<ValeGasHasRightsHomePage> {
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const H(32),
              HeaderHero(
                image: 'https://ldcapps.com/wp-content/uploads/2023/03/veja-se-voce-tem-direito-1.png',
                title: 'Descubra se você tem direito ao Vale Gás.',
                desc:
                    'Responda ao nosso Quiz super rápido para saber seu percentual de chances de se beneficiar do Vale Gás.',
              ),
              const H(32),
              ButtonIcon(
                  onTap: () => push(context, const ValeGasHasRightsTestPage()),
