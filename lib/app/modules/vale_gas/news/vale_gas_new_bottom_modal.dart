...
class ValeGasNewBottomModal extends JourneyStatefulWidget {
  final News news;
  const ValeGasNewBottomModal(this.news, {super.key}) : super(name: 'ValeGasNewBottomModal');

  @override
  State<ValeGasNewBottomModal> createState() => _ValeGasNewBottomModal();
}

class _ValeGasNewBottomModal extends State<ValeGasNewBottomModal> {
  @override
  void initState() {
