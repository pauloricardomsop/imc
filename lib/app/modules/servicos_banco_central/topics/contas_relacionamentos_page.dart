...
class ContasRelacionamentosPage extends AdStatefulWidget {
  ContasRelacionamentosPage({Key? key})
      : super(key: key, name: 'ContasRelacionamentosPage');

  @override
  State<ContasRelacionamentosPage> createState() =>
      _ContasRelacionamentosPageState();
}
