...
class EmprestimosFinanciamentosPage extends AdStatefulWidget {
  EmprestimosFinanciamentosPage({Key? key})
      : super(key: key, name: 'EmprestimosFinanciamentosPage');

  @override
  State<EmprestimosFinanciamentosPage> createState() =>
      _EmprestimosFinanciamentosPageState();
}

class _EmprestimosFinanciamentosPageState
    extends State<EmprestimosFinanciamentosPage> {
  List<CheckListModel> get checkList => [
        CheckListModel(
          icon: Symbols.check_circle,
          color: AppColors.success,
          label:
              'Avaliar se está muito endividado e se deve ou não contratar mais uma operação de crédito;',
        ),
        CheckListModel(
          icon: Symbols.check_circle,
          color: AppColors.success,
    ...
    return AppScaffold(
      bottom: Footer(
        AppButton(
          ...
          onTap: () async =>
              execUrl('https://registrato.bcb.gov.br/registrato/'),
        ),
      ),
      child: AppListView(
        children: [
