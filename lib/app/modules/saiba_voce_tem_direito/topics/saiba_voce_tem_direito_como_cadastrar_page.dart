...
class SaibaVoceTemDireitoComoCadastrarPage extends AdStatefulWidget {
  SaibaVoceTemDireitoComoCadastrarPage({Key? key})
      : super(key: key, name: 'SaibaVoceTemDireitoComoCadastrarPage');

  @override
  State<SaibaVoceTemDireitoComoCadastrarPage> createState() =>
      _SaibaVoceTemDireitoComoCadastrarPageState();
}

class _SaibaVoceTemDireitoComoCadastrarPageState
    extends State<SaibaVoceTemDireitoComoCadastrarPage> {
