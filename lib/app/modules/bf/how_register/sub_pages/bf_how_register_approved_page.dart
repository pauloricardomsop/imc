...
class BfHowRegisterHasApprovedPage extends JourneyStatefulWidget {
  const BfHowRegisterHasApprovedPage({super.key}) : super(name: 'BfHowRegisterHasApprovedPage');

  @override
  State<BfHowRegisterHasApprovedPage> createState() => _BfHowRegisterHasApprovedPage();
}

class _BfHowRegisterHasApprovedPage extends State<BfHowRegisterHasApprovedPage> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const H(32),
                  const HeaderHero(
                    image: 'https://ldcapps.com/wp-content/uploads/2023/03/beneficio-aprovado.jpg',
                    title: 'Como saber se fui aprovado no Bolsa Família?',
                    desc: 'Veja como saber se foi aprovado no Bolsa Família.',
                  ),
                  const H(32),
                  AppBannerAd(AdBannerStorage.get(widget.name)),
                  const H(32),
                  const SectionHeaderSm('Saiba se você foi aprovado.',
                      'Veja abaixo como acompanhar a sua aprovação no Bolsa Família.'),
                ],
              ),
            ),
