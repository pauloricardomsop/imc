...
import 'package:benefits_brazil/app/modules/bf/news/bf_new_bottom_modal.dart';
...
class BfNewsPage extends JourneyStatefulWidget {
  const BfNewsPage({super.key}) : super(name: 'BfNewsPage');

  @override
  State<BfNewsPage> createState() => _BfNewsPage();
}

class _BfNewsPage extends State<BfNewsPage> {
  final BfNewsController _bfNewsController = BfNewsController();
    ...
    return WillPopScope(
        ...
        child: AppScaffold(
          ...
          body: StreamOut<List<News>>(
            stream: _bfNewsController.newsStream.listen,
              ...
              onTap: () {
                AdController.showRewardAd(
                  onComplete: () => showModalBottomSheet(
                    ...
                    context: context,
                    builder: (_) => BfNewBottomModal(topList[i]),
                  ),
                );
              },
        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              const HeaderHero(
                title: 'Bolsa Família',
                desc: 'Confira as últimas notícias sobre o Bolsa Família 2023.',
              ),
              const H(24),
              ...bottomList
                  .map((e) => InkWell(
