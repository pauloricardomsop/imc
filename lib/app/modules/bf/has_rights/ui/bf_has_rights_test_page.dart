...
class BfHasRightsTestPage extends JourneyStatefulWidget {
  const BfHasRightsTestPage({super.key}) : super(name: 'BfHasRightsTestPage');

  @override
  State<BfHasRightsTestPage> createState() => _BfHasRightsTestPage();
}

class _BfHasRightsTestPage extends State<BfHasRightsTestPage> {
  final BfHasRightsController _bfQuizController = BfHasRightsController();
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: AppScaffold(
        ...
        body: StreamOut<BfHasRightsQuizValues>(
          stream: _bfQuizController.quizValuesStream.listen,
  ...
  Widget body(_, BfHasRightsQuizValues values) {
    return ListView(
      ...
      children: [
        ...
        if (values.pointsQuizOne == null)
          _quizItem(_, 'https://ldcapps.com/wp-content/uploads/2023/03/saudeeducacao.jpg', '1',
              'Saúde e Educação', '1 min', BfHasRightsQuiz.quizSaudeEducacao(context)),
        const H(16),
        if (values.pointsQuizTwo == null)
          _quizItem(_, 'https://ldcapps.com/wp-content/uploads/2023/03/baixa-renda.jpeg', '2',
              'Renda Familiar', '30 seg', BfHasRightsQuiz.quizRendaFamiliar(context)),
  ...
  Widget _approvedLevel(BuildContext context, BfHasRightsQuizValues values) {
