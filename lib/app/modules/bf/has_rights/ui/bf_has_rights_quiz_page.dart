...
class BfHasRightsQuizPage extends JourneyStatefulWidget {
  final Quiz quiz;

  const BfHasRightsQuizPage(this.quiz, {Key? key})
      : super(key: key, name: 'BfHasRightsQuizPage$quiz');

  @override
  State<BfHasRightsQuizPage> createState() => _QuizPageState();
}

class _QuizPageState extends State<BfHasRightsQuizPage> {
