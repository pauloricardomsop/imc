...
class ComoFuncionaQuemPodeParticiparPage extends AdStatefulWidget {
  ComoFuncionaQuemPodeParticiparPage({Key? key})
      : super(key: key, name: 'ComoFuncionaQuemPodeParticiparPage');

  @override
  State<ComoFuncionaQuemPodeParticiparPage> createState() =>
      _ComoFuncionaQuemPodeParticiparPageState();
}

class _ComoFuncionaQuemPodeParticiparPageState
    extends State<ComoFuncionaQuemPodeParticiparPage> {
