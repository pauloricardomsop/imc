...
class _ComoReceberMeusValoresPageState extends State<ComoReceberMeusValoresPage> {
  List<CheckListModel> get checkList => [
    CheckListModel(
      icon: Symbols.check_circle,
      color: AppColors.success,
      label: 'Se o sistema oferecer a opção “Solicitar por aqui”, selecione uma de suas chaves PIX, no campo obrigatório, e informe seus dados pessoais solicitados. \n\nGuarde o número de protocolo, para entrar em contato com a instituição, se necessário.',
    ),
    CheckListModel(
      icon: Symbols.check_circle,
      color: AppColors.success,
      label: 'Caso o sistema ofereça a opção “Solicitar por aqui”, mas não apresentar chave Pix disponível para seleção, entre em contato diretamente com a instituição financeira ou com o banco. \n\nO contato pode ser feito pelo telefone, e-mail informado ou presencialmente, para combinar a forma de devolução do dinheiro.',
    ),
  ];
