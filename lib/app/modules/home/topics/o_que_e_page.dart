...
class OQueEPage extends AdStatefulWidget {
  OQueEPage({Key? key})
      : super(key: key, name: 'OQueEPage');

  @override
  State<OQueEPage> createState() =>
      _OQueEPageState();
}
...
class _OQueEPageState extends State<OQueEPage> {
  List<CheckListModel> get checkList => [
    ...
    CheckListModel(
      icon: Symbols.check_circle,
      color: AppColors.success,
      label: 'Cotas de capital e rateio de sobras líquidas de ex-participantes de cooperativas de crédito;',
    ),
    CheckListModel(
      icon: Symbols.check_circle,
      color: AppColors.success,
    ...
    CheckListModel(
      icon: Symbols.check_circle,
      color: AppColors.success,
      label: 'Contas de registro mantidas por corretoras e distribuidoras encerradas com saldo disponível;',
    ),
    CheckListModel(
      icon: Symbols.check_circle,
      color: AppColors.success,
