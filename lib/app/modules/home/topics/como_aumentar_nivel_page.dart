...
class ComoAumentarNivelPage extends AdStatefulWidget {
  ...
  @override
  State<ComoAumentarNivelPage> createState() => _ComoAumentarNivelPageState();
}
    ...
    return AppScaffold(
      child: AppListView(
        children: [
          ...
          const H(24),
          AppImage(
              url: 'assets/images/nivelConta.png',
              isSVG: false,
              fit: BoxFit.fitHeight,
              height: MediaQuery.of(context).size.width),
          const H(24),
          ...
          const H(24),
          AppImage(
              url: 'assets/images/servicoAutorizacao.png',
              isSVG: false,
              fit: BoxFit.fitHeight,
              height: MediaQuery.of(context).size.width),
          const H(24),
