...
class _ComoReceberSeTenhoValoresPageState
  ...
  List<CheckListModel> get checkList => [
        ...
        CheckListModel(
            ...
            label: const Column(
              children: [
                AppDesc('Em seguida, será necessário informar os dados solicitados:'),
                H(12),
                PointsCheckList('CPF e data de nascimento, caso se trate de pessoa física.'),
                PointsCheckList('CNPJ e a data de abertura da empresa, em caso de pessoa jurídica;'),
              ],
            )),
        CheckListModel(
          icon: Symbols.check_circle,
        ...
        CheckListModel(
            ...
            label: const Column(
              children: [
                AppDesc('Depois disso, é necessário fazer o login com a conta gov.br.'),
                H(12),
                PointsCheckList('Para valores de pessoa física, é preciso que a conta gov.br seja de nível prata ou ouro.'),
                PointsCheckList('Para valores de pessoa jurídica, precisa ter conta gov.br com qualquer tipo de vínculo ao CNPJ, exceto de colaborador;'),
              ],
            )),
        CheckListModel(
        icon: Symbols.check_circle,
        ...
        label: 'Após realizar o login com sua conta gov.br, acesse a opção “Meus Valores a Receber”;',
          ...
          icon: Symbols.check_circle,
          color: AppColors.success,
          label: 'Por fim, caso tenha valores a receber, para solicitar o valor é preciso seguir as orientações indicadas pela plataforma.',
        ),
      ];
    ...
    return AppScaffold(
      child: AppListView(
        children: [
          ...
          const H(24),
          const AppDesc('Para realizar essa consulta, basta seguir o passo a passo:'),
          CheckList(checkList),
          const H(16),
          const BannerWidget(),
          const H(16),
      ...
      child: Row(
        ...
        children: [
          const Padding(
            ...
            child: Icon(Symbols.circle, color: AppColors.onSurface, fill: 1, size: 7),
          ),
          const W(8),
          Expanded(child: Text(label, style: const TextStyle(color: AppColors.onSurface).bodyLarge)),
        ],
      ),
    );
  }
