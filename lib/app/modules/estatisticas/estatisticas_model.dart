...
class EstatisticasValores {
  ...
  static Map<String, dynamic> defaultMap = {
    ...
    "estatisticas": {
      "home": {
        ...
        "valoresDevolvidos": [
          {"anoMes": "2023 - MAIO", "valorDevolvido": "R\$ 232 Milhões"},
          {"anoMes": "2023 - ABRIL", "valorDevolvido": "R\$ 260 Milhões"},
          {"anoMes": "2023 - MARÇO", "valorDevolvido": "R\$ 505 Milhões"},
          {"anoMes": "2023 - FEVEREIRO", "valorDevolvido": "R\$ 151 Milhões"},
          {"anoMes": "2023 - JANEIRO", "valorDevolvido": "R\$ 176 Milhões"},
          {"anoMes": "2022 - DEZEMBRO", "valorDevolvido": "R\$ 150 Milhões"}
        ]
      },
      "proximasDivulgacoes": [
        {"data": "07 DE JUNHO", "horario": "14:30"},
        {"data": "07 DE JULHO", "horario": "14:30"},
        {"data": "07 DE AGOSTO", "horario": "14:30"},
        {"data": "08 DE SETEMBRO", "horario": "14:30"},
        {"data": "06 DE OUTUBRO", "horario": "14:30"},
  ...
  EstatisticasValores.fromJson(Map<String, dynamic> json) {
    home =
        json['home'] != null ? EstatisticasCard.fromJson(json['home']) : null;
    estatisticas = json['estatisticas'] != null
        ? Estatisticas.fromJson(json['estatisticas'])
        : null;
  }
...
class EstatisticasHome {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (valoresDevolvidos != null) {
      data['valoresDevolvidos'] =
          valoresDevolvidos!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
