...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.kochava.kochava_tracker.KochavaTrackerPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin kochava_tracker, com.kochava.kochava_tracker.KochavaTrackerPlugin", e);
    }
    try {
